...
int main (int argc, char *argv[])
{
 ...
 /****ADDED BY ANIRUDH: MOBILITY INFORMATION***********/
  ...
  SSPosition1 = CreateObject<ConstantPositionMobilityModel> ();
  SSPosition1->SetPosition (Vector (250, 0, 0));
  ssNodes.Get (0)->AggregateObject (SSPosition1);

  SSPosition2 = CreateObject<ConstantPositionMobilityModel> ();
  SSPosition2->SetPosition (Vector (1000, 0, 0));
...
/****************END OF EDIT****************************/ 
  ...
  serverApps = udpServer.Install (ssNodes.Get (0));	// 10.1.1.1 is the server 
