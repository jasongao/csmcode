...
public class CSMOp implements Serializable {
	...
	// INSO
	public long order;
	public CSMLayer.Block block;

	public CSMOp(long id_, int p, int t, RegionKey src, RegionKey dst) {
