...
public class Globals {
        final static public boolean CACHE_ENABLED_ON_START = true;
        final static public double BENCHMARK_READ_DISTRIBUTION_ON_START = 0.6f;
        final static public long BENCHMARK_START_DELAY = 100L; // milliseconds
        ...
        final static public int MAX_X_REGIONS=2;
        final static public int MAX_Y_REGIONS=2;
